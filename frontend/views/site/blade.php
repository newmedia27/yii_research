...
<head>
    ...
    <title>Getpin – онлайн маркетинг всех локаций в едином кабинете</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
    <meta name="description" content="Расширяйте онлайн-присутствие. Управляйте отзывами. Получайте больше звонков, переходов на сайт и визитов в магазин">
    <meta name="keywords" content="getpin">
    <meta name="robots" content="index, nofollow">
    <meta property="og:title" content="Getpin – онлайн маркетинг всех локаций в едином кабинете">
    <meta property="og:description" content="Расширяйте онлайн-присутствие. Управляйте отзывами. Получайте больше звонков, переходов на сайт и визитов в магазин">
    <meta property="og:image" content="https://{{ env('DOMAIN') }}/img/favicons/android-chrome-512x512.png">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://{{ env('DOMAIN') }}/ru">
    <meta property="og:site_name" content="Getpin">
    <meta property="og:locale" content="ru_UA">
    <link rel="alternate" href="https://{{ env('DOMAIN') }}/en" hreflang="en">
    <link rel="alternate" href="https://{{ env('DOMAIN') }}/ru" hreflang="ru">
    <link rel="alternate" href="https://{{ env('DOMAIN') }}/ua" hreflang="uk">
    <link rel="alternate" href="https://{{ env('DOMAIN') }}/en" hreflang="x-default">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Ubuntu:400,500,600,700&amp;amp;subset=cyrillic,cyrillic-ext,latin-ext">
    <link rel="preconnect" href="//fonts.gstatic.com" crossorigin>
    <link rel="dns-prefetch" href="//cdnjs.cloudflare.com/">
    <link rel="stylesheet" type="text/css" href="{{asset('css/landing.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/landing-img-ru.min.css')}}">
    ...
    <script>
        ...
        })(window,document,'script','dataLayer','GTM-WF63JTQ');
    </script>
    <!-- End Google Tag Manager -->
</head>
<body>
    <!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WF63JTQ" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    <!-- End Google Tag Manager (noscript)-->
    <header class="header">
        <div class="header__content"><img class="header__logo" src="/img/landing/logo.png" srcset="/img/landing/logo@2x.png 2x, /img/landing/logo.png 1x" alt="Logo"><span class="header__languages"><a class="header__link" href="/en">EN</a><a class="header__link" href="/ua">UA</a><a class="header__link header__link--active" href="/ru">RU</a></span></div>
    </header>
    <section class="promo">
    ...
    <footer class="footer"><img class="footer__logo" src="/img/landing/logo-larger.png" srcset="/img/landing/logo-larger@2x.png 2x, /img/landing/logo-larger.png 1x" alt="Logo">
        <div class="footer__content">
            <div class="footer__description">
                <p class="footer__text">Эксперт по локальному маркетингу для бизнеса.</p>
                <ul class="footer__list">
                    <li class="footer__item">размещение информации о компании на картах, соц. сетях, в каталогах и досках объявлений; </li>
                    <li class="footer__item">публикация новостей/акций;</li>
                    <li class="footer__item">помощь в обработке отзывов ваших клиентов. </li>
                </ul>
                <p class="footer__text">Наши клиенты &mdash; национальные сети и малые бизнесы &mdash; управляют инструментами локального маркетинга из единого кабинета.</p>
            </div>
            <div class="footer__contact">
                <p class="footer__address">01033, Украина, Киев, улица Семьи Праховых, 50Б</p>
                <p class="footer__com"><a class="footer__link" href="tel:+380675092264">+38 067 509 2264</a></p>
                <p class="footer__com"> <a class="footer__link" href="mailto:hello@getpin.com">hello@getpin.com</a></p>
            </div>
            <div class="footer__brands"><img class="footer__brandicon" src="/img/landing/brandicon.png" srcset="/img/landing/brandicon@2x.png 2x, /img/landing/brandicon.png 1x" alt="brand"></div>
        </div>
    </footer>
